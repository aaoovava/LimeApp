...
public final class ActivityAfreezeDropBinding implements ViewBinding {
  ...
  private ActivityAfreezeDropBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView Correct,
  ...
  public static ActivityAfreezeDropBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAfreezeDropBinding((ConstraintLayout) rootView, Correct, baK, imageView13,
